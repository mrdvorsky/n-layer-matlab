classdef nLayerRectangular < nLayerForward & matlab.System
    ...
    %   NL = nLayerRectangular(maxM, maxN, waveguideA=7.112e-3, waveguideB=3.556e-3, ...
    ...
    properties (GetAccess = public, SetAccess = public)
        waveguideA = 1;         % Waveguide broad dimension.
        waveguideB = 0.5;       % Waveguide narrow dimension.
    ...
    %% Class constructor
    methods
        function O = nLayerRectangular(maxM, maxN, classProperties, options)
            ...
            %       specify this or the dimensions (waveguideA and
            %       waveguideB) directly.
            ...
            setProperties(O, numel(classProperties), classProperties{:});
